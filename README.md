...
**Общий вывод:** Итоговый показатель **mAP@0.50 = 81.99%** свидетельствует о том, что разработанная модель детекции дефектов является надежным и эффективным инструментом для автоматизированного анализа состояния зеленых насаждений и готова к практическому применению.
