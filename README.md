...
|----------------------|-------------------------------|
| ![Исходное фото деревьев](https://github.com/kira-Iight/Hackathon/tree/main/demonstration/Исходное_изображение.png) | ![Результат детекции](./demonstration/Результаты_анализа.png) |
...
Для обучения моделей глубокого обучения был сформирован расширенный датасет. Помимо предоставленных организаторами данных, он включает более 10.000 изображений, автоматически собранных с помощью парсера. Датисет содержит фотографии пород деревьев и кустарников, а также различные примеры их дефектов и повреждений.

**Методы аугментации данных**

Для увеличения объема и разнообразия обучающей выборки и повышения устойчивости моделей к изменчивости данных была применена аугментация. Использовались такие техники, как случайные отражения, повороты, изменение яркости, контрастности и масштаба.

**Методы аугментации данных**

С целью обеспечения надежности оценки обобщающей способности моделей и для более эффективного использования ограниченных данных была применена методология кросс-валидации. Обучение проводилось с использованием 5-фолдовой (five-fold) кросс-валидации, что позволяет оценить стабильность модели и снизить зависимость результатов от конкретного разбиения на обучающую и валидационную выборки.
## Функциональности
